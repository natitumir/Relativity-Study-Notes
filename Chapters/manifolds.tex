...
To see the components of dA, we expand the RHS of \cref{exterior_derivative_defined}. $ dA = \frac{1}{p!} \partial_m A_{a_1...a_p} dx^m \wedge dx^{a_1} \wedge ...dx^{a_p}$. So the $ \tt{dA}{}{ma_1...a_p}$ component of $ dA$ is given by $ \frac{1}{ \lera{p+1}!} \tt{dA}{}{ma_1...a_p}= \frac{1}{p!} \partial_m \tt{A}{}{a_1...a_p} \implies \tt{dA}{}{ma_1...a_p}= \lera{p+1} \partial_m \tt{A}{}{a_1...a_p} $ .
