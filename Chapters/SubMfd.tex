...
\begin{align*}
    & \tt{h}{}{ab} = \tt{g}{}{ab} - \varepsilon \tt{n}{}{a} \tt{n}{}{b} \numberthis \label{hab_explicit} \\
    & \tt{k}{}{ab} = \varepsilon \tt{n}{}{a} \tt{n}{}{b} \numberthis \label{kab_explicit} \\
\end{align*}
 
This is shown by testing this definition of $ \tt{h}{}{ab} = \tt{g}{}{ab} - \varepsilon \tt{n}{}{a} \tt{n}{}{b}$ against the main definition.
 
Take a vector $ X \in T$. I expect $ \tt{h}{}{ab} \tt{X}{b}{}$ to be $ \tt{g}{}{ab} \tt{X}{b}{}$. Now,
 
\begin{align*}
    \tt{h}{}{ab} \tt{X}{b}{} &= \lera{ \tt{g}{}{ab} - \varepsilon \tt{n}{}{a} \tt{n}{}{b}} \tt{X}{b}{} \\
    &= \tt{g}{}{ab} \tt{X}{b}{} - \varepsilon \tt{n}{}{a} \underbrace{ \tt{n}{}{b} \tt{X}{b}{}}_{=0} \\
    & \lera{ \text{$ X$ is tangent to S, $ n$ is normal}} \\
    &= \tt{g}{}{ab} \tt{X}{b}{} \\
\end{align*}
 
For a vector $ Y \in N$, I expect $ \tt{h}{}{ab} \tt{Y}{b}{} = 0$. It suffices to simply take $ \tt{n}{a}{} \in N$ as $ N$ is 1 dimensional anyways.
 
\begin{align*}
    \tt{h}{}{ab} \tt{n}{b}{} &= \lera{ \tt{g}{}{ab} - \varepsilon \tt{n}{}{a} \tt{n}{}{b}} \tt{n}{b}{} \\
    &= \tt{g}{}{ab} \tt{n}{b}{} - \varepsilon \tt{n}{}{a} \lera{ \tt{n}{}{b} \tt{n}{b}{}} \\
    &= \tt{n}{}{a} - \varepsilon^2 \tt{n}{}{a} \\
    &= \tt{n}{}{a} - \tt{n}{}{a} \\
    &= 0 \\
\end{align*}
 
Getting the form of $ \tt{k}{}{ab}$ is easy.
 
\begin{align*}
    \tt{k}{}{ab} = \tt{g}{}{ab} - \tt{h}{}{ab} = \tt{g}{}{ab} - \lera{ \tt{g}{}{ab} - \varepsilon \tt{n}{}{a} \tt{n}{}{b}} = \varepsilon \tt{n}{}{a} \tt{n}{}{b} \\
\end{align*}
...
\begin{align*}
    & \tt{K}{}{ab} = \tt{K}{}{abc} \tt{n}{c}{} \numberthis \label{Kab_defined} \\
\end{align*}
 
In the context of hypersurfaces, this is often called the ``Extrinsic Curvature'' or ``2nd Fundamental Form''.
 
Another way $ \tt{K}{}{ab}$ is expressed,
 
\begin{align*}
    & \tt{K}{}{ab} = - \tt{h}{p}{a} \tt{h}{q}{b} \nabla_p \tt{n}{}{q} \numberthis \label{Kab_in_terms_of_normal} \\
\end{align*}
 
\begin{align*}
    \tt{K}{}{ab} &= \tt{K}{}{abc} \tt{n}{c}{} \\
    &= \tt{h}{p}{a} \tt{h}{q}{b} \lera{ \nabla_p \tt{h}{}{qc}} \tt{n}{c}{} \\
    &= \tt{h}{p}{a} \tt{h}{q}{b} \lera{ \nabla_p \lera{ \underbrace{ \tt{h}{}{qc} \tt{n}{c}{}}_{=0}} - \tt{h}{}{qc} \nabla_p \tt{n}{c}{}} \\
    &= - \tt{h}{p}{a} \tt{h}{q}{b} \tt{h}{}{qc} \nabla_p \tt{n}{c}{} \\
    &= - \tt{h}{p}{a} \tt{h}{c}{b} \nabla_p \tt{n}{}{c} \\
    &= - \tt{h}{p}{a} \tt{h}{q}{b} \nabla_p \tt{n}{}{q} \\
\end{align*}
 
 
$ \tt{K}{}{[ab]} = 0$ ; $ \tt{K}{}{ab}$ is antisymmetric.
 
\begin{align*}
    & \tt{K}{}{[ab]} = \tt{K}{}{[ab]c} \tt{n}{c}{} = 0 \numberthis \label{Kab_bracket_zero} \\
\end{align*}
 
\begin{align*}
    & \tt{K}{}{abc} = \varepsilon \tt{K}{}{ab} \tt{n}{}{c} \numberthis \label{Kabc_in_terms_of_Kab} \\
\end{align*}
 
We show it by acting on both sides with an arbitrary vector. In this case, it suffices to act with $ \tt{X}{a}{} \in T$ and $ \tt{n}{a}{}$.
 
First, act with $ \tt{X}{a}{} \in T$.
 
\begin{align*}
    \text{LHS} &\implies \tt{K}{}{abc} \tt{X}{c}{} = 0 \\
    & \lera{ \text{$ \tt{K}{}{abc}$ is normal in the index c}} \\
    \text{RHS} &\implies \varepsilon \tt{K}{}{ab} \tt{n}{}{c} \tt{X}{c}{} = 0 \\
\end{align*}
 
Then, act with $ \tt{n}{a}{}$,
 
\begin{align*}
    \text{LHS} &\implies \tt{K}{}{abc} \tt{n}{c}{} = \tt{K}{}{ab} \\
    \text{RHS} &\implies \varepsilon \tt{K}{}{ab} \tt{n}{}{c} \tt{n}{c}{} = \varepsilon \tt{K}{}{ab} \varepsilon = \varepsilon^2 \tt{K}{}{ab} = \tt{K}{}{ab} \\
\end{align*}
 
Yet another way to express $ \tt{K}{}{ab}$ is,
 
\begin{align*}
    & \tt{K}{}{ab} = - \frac{1}{2} \Lie{n} \tt{h}{}{ab} \numberthis \label{Kab_as_lie_derivative} \\
\end{align*}
 
 
\section{Gauss-Codazzi eqns for hypersurface}
 
The first GC eqn was,
 
\begin{align*}
    \tt{ \mathcal{R}}{a}{bcd} &= \tt{R}{m}{npq} \tt{h}{a}{m} \tt{h}{n}{b} \tt{h}{p}{c} \tt{h}{q}{d} + 2 \du{K}{[c}{am} \tt{K}{}{d]bm} \\
    \implies \tt{ \mathcal{R}}{}{abcd} &= \tt{R}{}{mnpq} \tt{h}{m}{a} \tt{h}{n}{b} \tt{h}{p}{c} \tt{h}{q}{d} + 2 \du{K}{[c|a|}{m} \tt{K}{}{d]bm} \numberthis \label{first_gauss_codazzi} \\
\end{align*}
 
Now, I use the eqn $ \tt{K}{}{abc} = \varepsilon \tt{K}{}{ab} \tt{n}{}{c}$ in \cref{first_gauss_codazzi}. Start with the second term.
 
\begin{align*}
    \du{K}{[c|a|}{m} \tt{K}{}{d]bm} &= \varepsilon \tt{K}{}{[c|a|} \tt{n}{m}{} \; \varepsilon \tt{K}{}{d]b} \tt{n}{}{m} \\
    &= \tt{n}{m}{} \tt{n}{}{m} \varepsilon^2 \tt{K}{}{[c|a|} \tt{K}{}{d]b} \\
    &= - \varepsilon \tt{K}{}{a[c} \tt{K}{}{d]b} \\
\end{align*}
 
So, \cref{first_gauss_codazzi} $ \implies$
 
\begin{align*}
    & \tt{ \mathcal{R}}{}{abcd} = \tt{R}{}{mnpq} \tt{h}{m}{a} \tt{h}{n}{b} \tt{h}{p}{c} \tt{h}{q}{d} - 2 \varepsilon \tt{K}{}{a[c} \tt{K}{}{d]b} \numberthis \label{first_gauss_codazzi_final} \\
\end{align*}
 
The second GC eqn was,
 
\begin{align*}
    & \tt{h}{m}{[p} \tt{h}{a}{q]} \tt{h}{b}{r} \tt{k}{c}{s} \nabla_m \tt{K}{}{abc} = - \frac{1}{2} \tt{h}{m}{p} \tt{h}{a}{q} \tt{h}{b}{r} \tt{k}{c}{s} \tt{R}{}{mabc} \numberthis \label{second_gauss_codazzi} \\
\end{align*}
 
Now, to substitute $ \tt{K}{}{abc} = \varepsilon \tt{K}{}{ab} \tt{n}{}{c}$ in the LHS, I have,
 
\begin{align*}
    & \tt{h}{m}{[p} \tt{h}{a}{q]} \tt{h}{b}{r} \tt{k}{c}{s} \nabla_m \lera{ \varepsilon \tt{K}{}{ab} \tt{n}{}{c}} \\
    &= \varepsilon \tt{h}{m}{[p} \tt{h}{a}{q]} \tt{h}{b}{r} \tt{k}{c}{s} \lera{ \lera{ \nabla_m \tt{K}{}{ab}} \tt{n}{}{c} + \tt{K}{}{ab} \lera{ \nabla_m \tt{n}{}{c}}} \numberthis \label{second_gc_lhs_expanded} \\
\end{align*}
 
The second term in \cref{second_gc_lhs_expanded} actually goes to zero. Notice that, $ \tt{n}{a}{} \nabla_b \tt{n}{}{a} = 0$. This is because $ \tt{n}{a}{} \tt{n}{}{a} = \varepsilon$
 
\begin{align*}
    & \nabla_b \lera{ \tt{n}{a}{} \tt{n}{}{a}} = 0 \implies \tt{n}{a}{} \nabla_b \tt{n}{}{a} = 0 \\
\end{align*}
 
So,
 
\begin{align*}
    & \tt{k}{c}{s} \nabla_m \tt{n}{}{c} = \varepsilon \tt{n}{c}{} \tt{n}{}{s} \nabla_m \tt{n}{}{c} = \varepsilon \tt{n}{}{s} \tt{n}{c}{} \nabla_m \tt{n}{}{c} = 0 \\
\end{align*}
 
And this makes the 2nd term of \cref{second_gc_lhs_expanded} zero.
 
So, \cref{second_gc_lhs_expanded} $ \implies$
 
\begin{align*}
    & \tt{h}{m}{[p} \tt{h}{a}{q]} \tt{h}{b}{r} \tt{k}{c}{s} \nabla_m \lera{ \varepsilon \tt{K}{}{ab} \tt{n}{}{c}} \\
    &= \varepsilon \tt{h}{m}{[p} \tt{h}{a}{q]} \tt{h}{b}{r} \tt{k}{c}{s} \tt{n}{}{c} \nabla_m \tt{K}{}{ab} \\
    &= \varepsilon \tt{h}{m}{[p} \tt{h}{a}{q]} \tt{h}{b}{r} \tt{n}{}{s} \nabla_m \tt{K}{}{ab} \numberthis \label{second_gc_lhs_reduced} \\
\end{align*}
 
Using this in the LHS of \cref{second_gauss_codazzi} $ \implies$
